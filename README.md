...
| `allow_empty_config` | `false` | Allow `release_configs` to be empty. Use when decommissioning a repository to delete all configurations. Combine with `sync_delete: true`. |
> [!NOTE]
