...
Add `"$schema": "https://cdn.jsdelivr.net/gh/snhryt-neo/apply-dataform-workflows@v1/schema.json"` to your config file for editor autocompletion. See [`schema.json`](./schema.json) for the full schema.
